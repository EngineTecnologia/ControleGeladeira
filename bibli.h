//Bibliotecas, constantes e variáveis do sistema
...
unsigned long myChannelNumber = 1110320 ; //update
const char * myWriteAPIKey = "E4Q2ZSU7631V6XIN"; //update
